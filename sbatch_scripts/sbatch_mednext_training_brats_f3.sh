...
mednextv1_train 3d_fullres nnUNetTrainerV2_MedNeXt_B_kernel3 Task137_BraTS2021 3 -p nnUNetPlansv2.1_trgSp_1x1x1 -c


# E-mail diagnostic results to yourself using mailserver and a heredoc
mail -s "MedNeXt BraTS Fold 3 MICCAI 2023" ${USER}@asu.edu << EOF
Hi,
