...
mednextv1_train 3d_fullres nnUNetTrainerV2_MedNeXt_B_kernel3 Task017_AbdominalOrganSegmentation 1 -p nnUNetPlansv2.1_trgSp_1x1x1 -c -val


# E-mail diagnostic results to yourself using mailserver and a heredoc
mail -s "MedNeXt BTCV Fold 1 MICCAI 2023" ${USER}@asu.edu << EOF
Hi,
