...
mednextv1_train 3d_fullres nnUNetTrainerV2 Task017_AbdominalOrganSegmentation 4 -p nnUNetPlansv2.1_trgSp_1x1x1 -c


# E-mail diagnostic results to yourself using mailserver and a heredoc
mail -s "nnUNet BTCV Fold 4 MICCAI 2023" ${USER}@asu.edu << EOF
Hi,
