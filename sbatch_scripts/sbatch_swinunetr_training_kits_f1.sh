...
mednextv1_train 3d_fullres nnUNetTrainerV2_SwinUNETR_128x128x128 Task040_KiTS2019 1 -p nnUNetPlansv2.1_trgSp_1x1x1 -val


# E-mail diagnostic results to yourself using mailserver and a heredoc
mail -s "SwinUNETR KiTS Fold 1 MICCAI 2023" ${USER}@asu.edu << EOF
Hi,
