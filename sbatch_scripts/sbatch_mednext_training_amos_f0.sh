...
#SBATCH -e /scratch/msarava7/IAI/Results/Benchmarking_Runs/slurm.amos.seg.mednext.%x.%j.err # file to save job's STDERR (%j = JobId)
...
mednextv1_train 3d_fullres nnUNetTrainerV2_MedNeXt_B_kernel3 Task218_AMOS2022_task1 0 -p nnUNetPlansv2.1_trgSp_1x1x1 -val


# E-mail diagnostic results to yourself using mailserver and a heredoc
mail -s "MedNeXt AMOS Fold 0 MICCAI 2023" ${USER}@asu.edu << EOF
Hi,
