...
mednextv1_train 3d_fullres nnUNetTrainerV2_MedNeXt_B_kernel3 Task617_AbdomenCT_subtask1 4 -p nnUNetPlansv2.1_trgSp_1x1x1 -val


# E-mail diagnostic results to yourself using mailserver and a heredoc
mail -s "MedNeXt ABD_CT Fold 4 MICCAI 2023" ${USER}@asu.edu << EOF
Hi,
