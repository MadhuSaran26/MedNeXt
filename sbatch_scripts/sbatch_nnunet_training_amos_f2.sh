...
mednextv1_train 3d_fullres nnUNetTrainerV2 Task218_AMOS2022_task1 2 -p nnUNetPlansv2.1_trgSp_1x1x1 -val


# E-mail diagnostic results to yourself using mailserver and a heredoc
mail -s "nnUNet AMOS Fold 2 MICCAI 2023" ${USER}@asu.edu << EOF
Hi,
