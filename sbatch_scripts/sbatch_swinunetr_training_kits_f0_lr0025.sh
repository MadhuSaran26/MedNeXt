...
mednextv1_train 3d_fullres nnUNetTrainerV2_SwinUNETR_128x128x128_lr_0_0025 Task040_KiTS2019 0 -p nnUNetPlansv2.1_trgSp_1x1x1 -val


# E-mail diagnostic results to yourself using mailserver and a heredoc
mail -s "SwinUNETR 0.0025LR KiTS Fold 0 MICCAI 2023" ${USER}@asu.edu << EOF
Hi,
